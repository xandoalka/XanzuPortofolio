    ...
    return(
        <section className="text-white pt-20 pb-0 sm:py-20">
            <div className="w-[85%] lg:w-[80%] mx-auto">
                ...
                <div className="flex justify-around lg:gap-6 flex-wrap xl:flex-nowrap mb-10">
                    {data.map(project => (
                ...
                <div className='hidden sm:flex bg-neutral-card flex-col md:flex-row lg:justify-between'>
